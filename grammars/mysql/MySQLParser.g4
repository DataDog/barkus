...
tsDataFileName
    ...
    |  (ADD_SYMBOL tsDataFile)? // now optional
    ;
...
sourceOrder
    :  IN_SYMBOL PRIMARY_SYMBOL KEY_SYMBOL ORDER_SYMBOL
    ;
...
loadAlgorithm
    :  ALGORITHM_SYMBOL EQUAL_OPERATOR BULK_SYMBOL
    ;

loadParallel
    :  PARALLEL_SYMBOL EQUAL_OPERATOR INT_NUMBER
    ;

loadMemory
    :  MEMORY_SYMBOL EQUAL_OPERATOR sizeNumber
    ;
...
queryExpressionBody
    ...
    (
        (
            UNION_SYMBOL
            |  (EXCEPT_SYMBOL | INTERSECT_SYMBOL)
...
jtColumn
    ...
    | identifier dataType ( collate)? EXISTS_SYMBOL? PATH_SYMBOL textStringLiteral
...
sourceDefinition
    ...
    |  ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL EQUAL_OPERATOR
...
histogramAutoUpdate
    :  (MANUAL_SYMBOL | AUTO_SYMBOL) UPDATE_SYMBOL
    ;
...
showParseTreeStatement
    :  SHOW_SYMBOL PARSE_TREE_SYMBOL simpleStatement
    ;
...
explainStatement
    : (EXPLAIN_SYMBOL | DESCRIBE_SYMBOL | DESC_SYMBOL) explainOptions? (
         FOR_SYMBOL DATABASE_SYMBOL textOrIdentifier
...
tablesampleClause
    :  TABLESAMPLE_SYMBOL samplingMethod OPEN_PAR_SYMBOL samplingPercentage CLOSE_PAR_SYMBOL
    ;
...
runtimeFunctionCall
    ...
    |  LOG_SYMBOL OPEN_PAR_SYMBOL expr (
        COMMA_SYMBOL expr
    )? CLOSE_PAR_SYMBOL
...
columnAttribute
    ...
    |  constraintEnforcement
    |  value = ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    |  value = SECONDARY_ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    |  visibility
    ;
...
createTableOption
    ...
    |  option = ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    |  option = SECONDARY_ENGINE_ATTRIBUTE_SYMBOL EQUAL_OPERATOR? jsonAttribute
    |  tsOptionAutoextendSize
    ;
