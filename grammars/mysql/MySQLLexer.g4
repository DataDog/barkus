...
MASTER_TLS_VERSION_SYMBOL
    : M A S T E R '_' T L S '_' V E R S I O N                                             
    ;
...
SECONDARY_ENGINE_SYMBOL
    : S E C O N D A R Y '_' E N G I N E                                                   
    ;                                                                                     // MYSQL

SECONDARY_LOAD_SYMBOL
    : S E C O N D A R Y '_' L O A D                                                       
    ;                                                                                     // MYSQL

SECONDARY_UNLOAD_SYMBOL
    : S E C O N D A R Y '_' U N L O A D                                                   
    ;                                                                                     // MYSQL
...
NETWORK_NAMESPACE_SYMBOL
    : N E T W O R K '_' N A M E S P A C E                                                 
    ;                                                                                     // MYSQL
...
ENGINE_ATTRIBUTE_SYMBOL
    : E N G I N E '_' A T T R I B U T E                                                   
    ;                                                                                     // MYSQL

SECONDARY_ENGINE_ATTRIBUTE_SYMBOL
    : S E C O N D A R Y '_' E N G I N E '_' A T T R I B U T E                             
    ;                                                                                     // MYSQL

SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL
    : S O U R C E '_' C O N N E C T I O N '_' A U T O '_' F A I L O V E R                 
    ;                                                                                     // MYSQL
...
GRAMMAR_SELECTOR_DERIVED_EXPR
    : G R A M M A R '_' S E L E C T O R '_' D E R I V E D                                 
...
ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL
    : A S S I G N '_' G T I D S '_' T O '_' A N O N Y M O U S '_' T R A N S A C T I O N S 
    ;                                                                                     // MYSQL

GET_SOURCE_PUBLIC_KEY_SYMBOL
    : G E T '_' S O U R C E '_' P U B L I C '_' K E Y                                     
    ;                                                                                     // MYSQL

SOURCE_AUTO_POSITION_SYMBOL
    : S O U R C E '_' A U T O '_' P O S I T I O N                                         
    ;                                                                                     // MYSQL

SOURCE_BIND_SYMBOL
    : S O U R C E '_' B I N D                                                             
    ;                                                                                     // MYSQL

SOURCE_COMPRESSION_ALGORITHM_SYMBOL
    : S O U R C E '_' C O M P R E S S I O N '_' A L G O R I T H M                         
    ;                                                                                     // MYSQL

SOURCE_COMPRESSION_ALGORITHMS_SYMBOL
    : S O U R C E '_' C O M P R E S S I O N '_' A L G O R I T H M S                       
      -> type(SOURCE_COMPRESSION_ALGORITHM_SYMBOL)
    ;                                                                                     // MYSQL

SOURCE_CONNECT_RETRY_SYMBOL
    : S O U R C E '_' C O N N E C T '_' R E T R Y                                         
    ;                                                                                     // MYSQL

SOURCE_DELAY_SYMBOL
    : S O U R C E '_' D E L A Y                                                           
    ;                                                                                     // MYSQL

SOURCE_HEARTBEAT_PERIOD_SYMBOL
    : S O U R C E '_' H E A R T B E A T '_' P E R I O D                                   
    ;                                                                                     // MYSQL

SOURCE_HOST_SYMBOL
    : S O U R C E '_' H O S T                                                             
    ;                                                                                     // MYSQL

SOURCE_LOG_FILE_SYMBOL
    : S O U R C E '_' L O G '_' F I L E                                                   
    ;                                                                                     // MYSQL

SOURCE_LOG_POS_SYMBOL
    : S O U R C E '_' L O G '_' P O S                                                     
    ;                                                                                     // MYSQL

SOURCE_PASSWORD_SYMBOL
    : S O U R C E '_' P A S S W O R D                                                     
    ;                                                                                     // MYSQL

SOURCE_PORT_SYMBOL
    : S O U R C E '_' P O R T                                                             
    ;                                                                                     // MYSQL

SOURCE_PUBLIC_KEY_PATH_SYMBOL
    : S O U R C E '_' P U B L I C '_' K E Y '_' P A T H                                   
    ;                                                                                     // MYSQL

SOURCE_RETRY_COUNT_SYMBOL
    : S O U R C E '_' R E T R Y '_' C O U N T                                             
    ;                                                                                     // MYSQL
...
SOURCE_SSL_CA_SYMBOL
    : S O U R C E '_' S S L '_' C A                                                       
    ;                                                                                     // MYSQL

SOURCE_SSL_CAPATH_SYMBOL
    : S O U R C E '_' S S L '_' C A P A T H                                               
    ;                                                                                     // MYSQL

SOURCE_SSL_CERT_SYMBOL
    : S O U R C E '_' S S L '_' C E R T                                                   
    ;                                                                                     // MYSQL

SOURCE_SSL_CIPHER_SYMBOL
    : S O U R C E '_' S S L '_' C I P H E R                                               
    ;                                                                                     // MYSQL

SOURCE_SSL_CRL_SYMBOL
    : S O U R C E '_' S S L '_' C R L                                                     
    ;                                                                                     // MYSQL

SOURCE_SSL_CRLPATH_SYMBOL
    : S O U R C E '_' S S L '_' C R L P A T H                                             
    ;                                                                                     // MYSQL
...
SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL
    : S O U R C E '_' S S L '_' V E R I F Y '_' S E R V E R '_' C E R T                   
    ;                                                                                     // MYSQL

SOURCE_TLS_CIPHERSUITES_SYMBOL
    : S O U R C E '_' T L S '_' C I P H E R S U I T E S                                   
    ;                                                                                     // MYSQL

SOURCE_TLS_VERSION_SYMBOL
    : S O U R C E '_' T L S '_' V E R S I O N                                             
    ;                                                                                     // MYSQL

SOURCE_USER_SYMBOL
    : S O U R C E '_' U S E R                                                             
    ;                                                                                     // MYSQL

SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL
    : S O U R C E '_' Z S T D '_' C O M P R E S S I O N '_' L E V E L                     
    ;                                                                                     // MYSQL
...
CHALLENGE_RESPONSE_SYMBOL
    : C H A L L E N G E '_' R E S P O N S E                                               
    ;                                                                                     // MYSQL
...
INTERSECT_SYMBOL
    : I N T E R S E C T '_' S Y M B O L                                                   
    ;                                                                                     // SQL-1992-R
